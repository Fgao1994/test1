...
public class HttpMainTest {
	...
	public static void execute(){
		...
		String Server_Dir = "/home/fgao/websocket/openmi/floodmodel/";
		...
		Argument gisVolumnInputArgument = new Argument("out_file",Server_Dir+"GisVolumnOutput.txt",true);
		HttpGisVolumnModel gisVolumnModel = new HttpGisVolumnModel();
