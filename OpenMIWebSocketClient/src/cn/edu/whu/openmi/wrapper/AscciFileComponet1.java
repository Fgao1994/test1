...
public class AscciFileComponet1 extends LinkableComponent {
	...
	public AscciFileComponet1(String id) {
		super(id);
	}

	public AscciFileComponet1() {
...
//		return super.getValuesHook(time, link);
	...
	public static void main(String[] args) {
		...
		AscciFileComponet1 ascciFileComponet = new AscciFileComponet1();
