...
public class MyHttpClient190Server {
	public static String httpurl = "http://202.114.118.190:8086/OpenMIWebSocketServer/httptest";
	public static String sendMsg = ValueSent.STR_10B;
