...
public class WebSocketMainTest2_190Server {
...
//		Argument TopmodelTIArgument = new Argument("TI","F:\\360sync\\sync\\openmi\\workspace\\OpenMI-1.4-SDK\\src\\cn\\edu\\whu\\openmi\\models\\topmodel\\TI_raster.txt",true);
		...
		Argument TopmodelTIArgument = new Argument("TI","/home/giservice/openmi/TI_raster.txt",true);
		Argument TopmodeloutputFileArgument = new Argument("OutputData","/home/giservice/openmi/Topmodel_output.txt",true);
		Argument topmodelProvOutArgument = new Argument("ProvOut","/home/giservice/openmi/Topmodel_prov.txt",true);
		...
		WSTopModel2 topModel = new WSTopModel2();
...
//		componet1.dispose();
	...
	public static void main(String[] args){
		...
		long start_time = System.currentTimeMillis();
		WebSocketMainTest2_190Server.execute();
		long end_time = System.currentTimeMillis();
		System.out.println("Websocket用时"+(end_time-start_time));
	}
}
