...
public class WSSyncMainTest {
	public static void execute(){
		...
		String Base_Dir = "/home/fgao/websocket/openmi/";
		//String Base_Dir = "D:/websocket/openmi/";
...
//		hargreavesModel.getTimeHorizon()
		...
		Argument TopmodeloutputFileArgument = new Argument("OutputData",Base_Dir+"WSTopmodel_output.txt",true);
		Argument topmodelProvOutArgument = new Argument("ProvOut",Base_Dir+"WSTopmodel_prov.txt",true);
		...
		WSSyncTopModel topModel = new WSSyncTopModel();
...
//		componet1.dispose();
	...
	public static void main(String[] args){
		...
		//添加System.exit(0)有可能导致线程阻塞，如果采用脚本运行，这句必须有。回头再修改
		System.exit(0);
	}
}
