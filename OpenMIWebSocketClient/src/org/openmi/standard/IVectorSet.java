...
/**
 * VectorSet interface (Array of vectors for a certain quantity on a certain
 * elementset).
 */
public interface IVectorSet extends IValueSet {

    /**
     * Vector for one of the elements in the set
     *
     * @param elementIndex index in the vector set.
     * @return vector.
     */
