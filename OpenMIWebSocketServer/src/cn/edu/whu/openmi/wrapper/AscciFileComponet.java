...
public class AscciFileComponet extends LinkableComponent {
	...
	public AscciFileComponet(String id) {
		super(id);
	}

	public AscciFileComponet() {
		super("AscciFile-OpenMI-Compliant-Component-1");
		...
		try {
			for (String line = br.readLine(); line != null; line = br
				...
				if (!elementsRead) {
					...
					elementSet.setID("File Contents");
				...
				for(int i=0;i<3;i++){
					locs[0] = Double.parseDouble(values[i+1]);
				}
				timeValues.add(locs);
			}
...
//		return super.getValuesHook(time, link);
	...
	public static void main(String[] args) {
		...
		AscciFileComponet ascciFileComponet = new AscciFileComponet();
